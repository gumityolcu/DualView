...
def evaluate(model_name, model_path, device, class_groups,
    ...
    for p in range(pages):
        ...
        #generate_all_pixel_attributions(model, train, test, cumul_xpl[start_ind:start_ind+T], indices, save_dir, fname, T, device, composite='EpsilonAlpha2Beta1', canonizer=canonizer, modes=["img","heatmap"], start_ind=start_ind-offset, include_test=True)
